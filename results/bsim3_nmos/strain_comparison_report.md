...
- Device netlist: `/home/yongfu/proj/strained-device-model/models/bsim3_nmos.subckt`
- Wrapper output directory: `/home/yongfu/proj/strained-device-model/results/bsim3_nmos`
...
```bash
strain-spice run --device /home/yongfu/proj/strained-device-model/models/bsim3_nmos.subckt --config <your-config.yaml> --output /home/yongfu/proj/strained-device-model/results/bsim3_nmos
```

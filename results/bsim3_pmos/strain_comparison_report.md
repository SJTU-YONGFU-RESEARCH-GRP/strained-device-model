...
- Device netlist: `/mnt/d/proj/strained-device-model/models/bsim3_pmos.subckt`
- Wrapper output directory: `/mnt/d/proj/strained-device-model/results/bsim3_pmos`
...
```bash
strain-spice run --device /mnt/d/proj/strained-device-model/models/bsim3_pmos.subckt --config <your-config.yaml> --output /mnt/d/proj/strained-device-model/results/bsim3_pmos
```

...
- Wrapper output directory: `/home/yongfu/proj/strained-device-model/results/bsim4_nmos`
...
```bash
strain-spice run --device /home/yongfu/proj/strained-device-model/models/bsim4_nmos.subckt --config <your-config.yaml> --output /home/yongfu/proj/strained-device-model/results/bsim4_nmos
```
